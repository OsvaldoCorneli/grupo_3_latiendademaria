...
for (let i in productos) {
    ...
    //productos = productos.filter((x) => x.id !== productos[i].id)
    nvo.push({...productos[i], color: colors })
}

console.log(nvo)
fs.writeFileSync(__dirname+'/productos2.json', JSON.stringify(nvo,0,4),'utf-8')